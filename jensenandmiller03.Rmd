...
The main contribution form jensen and Miller's report is the identification if real life giffen goods
and how they interact with the sociities in our world. Initially giffen goods seem to break the law
of demand but as a result of this paper, things seem to less concrete than thought before.

 in project 01 we replicated Panel A and Panel B of Table 1- "Means and Standard Deviations of Key variables. A signficant finding is that the consuption of wheat is much lower per person on average, but gansu has almost the exact different pattern. with wheat based foods are dominiant.

In projet 02 we ran regression for our data sets, which allowed us to then run an F and T test for overall validity, and variable significance of our model. 
...
# Make the dataset at household level
